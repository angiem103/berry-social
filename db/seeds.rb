...
Event.create( user_id: 1, client_id: 2, name:"Angie's Graduation Party", description: "Halloween themed graduation party", start_date: "2023-01-10", start_time: "20:00:00", end_date: "2023-01-10", end_time: "23:00:00", location: Faker::Address.unique.full_address, budget: 1000)
Event.create( user_id: 1, client_id: 1, name:"Daniel's Birthday Party", description: "Baby Shark theme birthday party", start_date: "2023-01-25", start_time: "13:00:00", end_date: "2023-01-25", end_time: "18:00:00", location: Faker::Address.unique.full_address, budget: 500)
