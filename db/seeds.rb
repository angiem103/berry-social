...
Vendor.create( name: "Party Perfect", contact_person: "Lucia Salazar", phone_number: Faker::Base.numerify('(###) ### ####'), email: Faker::Internet.free_email(name: 'Luica'), desc_of_serv: "Decoration services for parties and weddings", user_id: 2)
