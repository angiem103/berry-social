...
Event.create( user_id: 2, client_id: 4, name:"Eva's 1st Birthday", description: "Hello Kitty themed birthday party for 1 year old. Parents requested Hello Kitty costume entertainer", start_date: "2023-06-15", start_time: "13:00:00", end_date:"2023-06-15", end_time:"1:00:00",location: Faker::Address.unique.full_address, budget: 3000, current_cost: 500 )
