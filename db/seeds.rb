...
Event.create( user_id: 1, client_id: 1, name:"Jackie's 30th Birthday", description: "All black 30th Birthday Party. Event theme is Funeral for her 20s", start_date: "2023-04-25",  start_time: "19:00:00",  end_date: "2023-04-25", end_time: "23:00:00", location: Faker::Address.unique.full_address, budget: 5000, current_cost: 3000)
Event.create( user_id: 1, client_id: 2, name:"Jessica's and Eduardo's Babyshower", description: "Winnie The Pooh themed baby shower for a baby boy. Parents requested green and beige decorations", start_date: "2023-05-01", start_time: "15:00:00", end_date: "2023-05-01", end_time: "19:00:00", location: Faker::Address.unique.full_address, budget: 2000, current_cost: 600 )
Event.create( user_id: 2, client_id: 3, name:"Pet Adoption Paw-ty", description: "Pet adoption event open to the public to raise awareness about the importance of adoption. Customer requested animal safe environment and pet friendly treats", start_date: "2023-3-31", start_time: "12:00:00", end_date: "2023-03-31", end_time: "16:00:00", location: Faker::Address.unique.full_address, budget: 1000, current_cost: 200 )
Event.create( user_id: 2, client_id: 4, name:"Eva's 1st Birthday", description: "Hello Kitty themed birthday party for 1 year old. Parents requested Hello Kitty costume entertainer", start_date: "2023-06-15", start_time: "13:00:00", end_date:"2023-06-15", end_time:"17:00:00",location: Faker::Address.unique.full_address, budget: 3000, current_cost: 500 )
...
EventVendor.create( event_id: 1, vendor_id: 2, total_cost: 1000, left_to_pay: 500)
